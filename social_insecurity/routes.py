...
def stream(username: str):
    ...
    if post_form.is_submitted():
        insert_post = """
            ...
            """
        # image field may be None; guard access if needed in templates/routes
        image_filename = None
...
def comments(username: str, post_id: int):
    ...
    return render_template("comments.html.j2", title="Comments", username=username, post=post, comments=comments, form=comments_form)
...
def profile(username: str):
    ...
    if profile_form.is_submitted():
        ...
        sqlite.query(
            ...
            getattr(profile_form, "birthday", None) and getattr(profile_form.birthday, "data", None),
            username,
        )
